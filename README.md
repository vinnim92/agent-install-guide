...
```bash
curl -fsSL https://cdn.jsdelivr.net/gh/vinnim92/agent-install-guide@v3.0.7/scripts/install-claude-code.sh | AGENT_INSTALL_YES=1 bash
```

**Codex：**

```bash
curl -fsSL https://cdn.jsdelivr.net/gh/vinnim92/agent-install-guide@v3.0.7/scripts/install-codex.sh | AGENT_INSTALL_YES=1 bash
```
