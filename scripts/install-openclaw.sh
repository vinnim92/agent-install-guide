...
show_help() {
    ...
    echo ""
    echo "推荐一行安装命令:"
    echo "  curl -fsSL https://vinnim92.github.io/agent-install-guide/i/openclaw.sh | bash"
    echo ""
    echo "如需手动确认，请先下载脚本再运行:"
    echo "  curl -fsSL https://vinnim92.github.io/agent-install-guide/i/openclaw.sh -o openclaw.sh"
