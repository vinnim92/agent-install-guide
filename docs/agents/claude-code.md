...
```bash
curl -fsSL https://cdn.jsdelivr.net/gh/vinnim92/agent-install-guide@v3.0.9/scripts/install-claude-code.sh | bash -s -- --dry-run
```

### Windows

```powershell
iwr -useb https://cdn.jsdelivr.net/gh/vinnim92/agent-install-guide@v3.0.9/scripts/install-claude-code.ps1 -OutFile install-claude-code.ps1
