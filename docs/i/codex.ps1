# Codex Windows entry — auto-redirects to latest stable installer
...
if ($env:GITEE_ACCOUNT) {
    $sources += @{Name="Gitee 国内镜像"; Url="https://gitee.com/$env:GITEE_ACCOUNT/agent-install-guide/raw/main/scripts/install-codex.ps1"}
}

$sources += @{Name="jsDelivr CDN"; Url="https://cdn.jsdelivr.net/gh/vinnim92/agent-install-guide@$Version/scripts/install-codex.ps1"}

$sources += @{Name="GitHub raw"; Url="https://raw.githubusercontent.com/vinnim92/agent-install-guide/$Version/scripts/install-codex.ps1"}
